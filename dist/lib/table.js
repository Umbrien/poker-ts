...
var Table = /** @class */ (function () {
    ...
    Table.fromJSON = function (json) {
        ...
        if (json._dealer && table._communityCards) {
            ...
            var tempDealer = dealer_1.default.fromJSON(json._dealer);
            ...
            tempDealer._deck = table._deck;
            tempDealer._communityCards = table._communityCards;
            ...
            table._handPlayers = tempDealer._players;
        }
        else {
